...
def setup_product():
    ...
    import example.electionperson
    zcml.load_config('configure.zcml', example.electionperson)
    ...
    ztc.installPackage('example.electionperson')
...
setup_product()
ptc.setupPloneSite(products=['example.electionperson'])
